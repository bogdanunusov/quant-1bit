...
// === GEMMA4 1-BIT ROW-WISE (added) ===
#define GEMMA4_1BIT_R5376_ROW_LEN 5376
#define GEMMA4_1BIT_R5376_PACKED_BYTES (GEMMA4_1BIT_R5376_ROW_LEN / 8)
typedef struct {
    ggml_half scale_pos;
    ggml_half scale_neg;
    uint8_t   packed_bits[GEMMA4_1BIT_R5376_PACKED_BYTES];
} block_gemma4_1bit_r5376;
static_assert(sizeof(block_gemma4_1bit_r5376) == 2*sizeof(ggml_half) + GEMMA4_1BIT_R5376_PACKED_BYTES, "wrong size");

#define GEMMA4_1BIT_R8192_ROW_LEN 8192
#define GEMMA4_1BIT_R8192_PACKED_BYTES (GEMMA4_1BIT_R8192_ROW_LEN / 8)
typedef struct {
    ggml_half scale_pos;
    ggml_half scale_neg;
    uint8_t   packed_bits[GEMMA4_1BIT_R8192_PACKED_BYTES];
} block_gemma4_1bit_r8192;
static_assert(sizeof(block_gemma4_1bit_r8192) == 2*sizeof(ggml_half) + GEMMA4_1BIT_R8192_PACKED_BYTES, "wrong size");

#define GEMMA4_1BIT_R21504_ROW_LEN 21504
#define GEMMA4_1BIT_R21504_PACKED_BYTES (GEMMA4_1BIT_R21504_ROW_LEN / 8)
typedef struct {
    ggml_half scale_pos;
    ggml_half scale_neg;
    uint8_t   packed_bits[GEMMA4_1BIT_R21504_PACKED_BYTES];
} block_gemma4_1bit_r21504;
static_assert(sizeof(block_gemma4_1bit_r21504) == 2*sizeof(ggml_half) + GEMMA4_1BIT_R21504_PACKED_BYTES, "wrong size");

#define GEMMA4_1BIT_R262144_ROW_LEN 262144
#define GEMMA4_1BIT_R262144_PACKED_BYTES (GEMMA4_1BIT_R262144_ROW_LEN / 8)
typedef struct {
    ggml_half scale_pos;
    ggml_half scale_neg;
    uint8_t   packed_bits[GEMMA4_1BIT_R262144_PACKED_BYTES];
} block_gemma4_1bit_r262144;
static_assert(sizeof(block_gemma4_1bit_r262144) == 2*sizeof(ggml_half) + GEMMA4_1BIT_R262144_PACKED_BYTES, "wrong size");
